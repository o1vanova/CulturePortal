...
const MemberCard = ({ member }: MemberCardProps): JSX.Element => {  
  return (
    <Card bg="dark" className="Member-card mt-3 mb-3 border-0 rounded-0">                
      ...
      <Card.Footer>        
          <a href={member.github}><Icon className="Icon-member mr-1" width="32" icon={githubIcon} /></a>                            
          <a href={member.telegram}><Icon className="Icon-member mr-1" width="32" icon={telegramIcon} /></a>    
          { member.codewar != null ? 
